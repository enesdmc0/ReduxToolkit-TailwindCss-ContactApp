            ...
            <div className="flex flex-col min-h-[calc(100vh_-_65px)]">
                <form onSubmit={handleSubmit} className="border-b border-b-black w-full h-64 flex items-center justify-center flex-col p-6">
                   ...
                   <div className="gap-10 flex">
                       ...
                       <button onClick={handleRemove} className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                           All Delete
                       </button>
                   </div>
                </form>
